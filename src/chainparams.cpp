...
public:
    CMainParams() {
        ...
        consensus.btvPowLimit = uint256S(BTV_BRANCH_POW_LIMIT);
        ...
        vSeeds.emplace_back("seed3.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed4.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed5.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed6.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed7.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed8.bitvote.one", true); // Seed2 of bitvote.one
        vSeeds.emplace_back("seed9.bitvote.one", true); // Seed2 of bitvote.one
        ...
        checkpointData = {
            {
				...
				{505160, uint256S("0x0000b071e53434dfe5c13462acf4c71f985a90e7c9de36bd46d9a4fb583f19e6")},
            }
        };
